  ...
  return (
    <Landing>
      ...
      <div className="h-screen w-full  container mx-auto flex items-center justify-evenly md:justify-between relative flex-col md:flex-row">
        <div className="w-full  md:h-full flex items-center justify-center flex-col mx-auto">
        ...
        <div className="w-2/4 md:w-3/4  md:h-full flex items-center justify-center ">
          <img
